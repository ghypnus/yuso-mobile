...
var Axis = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Axis, [{
    ...
    value: function render() {
      ...
      var wrap = (0, _classnames3["default"])(prefixCls, className);
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: wrap
      }, (title || extra) && /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _classnames3["default"])("".concat(prefixCls, "-header"), _defineProperty({}, "".concat(prefixCls, "-header-undeline"), data.length > 0))
      ...
      }, extra)), data.length > 0 && /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var titleWrap = (0, _classnames3["default"])("".concat(prefixCls, "-item-center-title"), _defineProperty({}, "".concat(prefixCls, "-item-center-title-right"), item.align === 'right'));
        return /*#__PURE__*/_react["default"].createElement("div", {
          key: "".concat(prefixCls, "-").concat(idx),
          className: "".concat(prefixCls, "-item")
        }, line && /*#__PURE__*/_react["default"].createElement("div", {
          className: "".concat(prefixCls, "-item-node")
        }, item.node ? item.node : /*#__PURE__*/_react["default"].createElement("div", {
          className: "".concat(prefixCls, "-item-node-point")
        }, /*#__PURE__*/_react["default"].createElement("i", null)), idx === data.length - 1 ? lastLine ? /*#__PURE__*/_react["default"].createElement("div", {
        ...
        }, item.date), item.title && /*#__PURE__*/_react["default"].createElement("div", {
          className: titleWrap
        }, item.title, /*#__PURE__*/_react["default"].createElement("div", {
          className: "".concat(prefixCls, "-item-center-title-extra")
        }, item.extra)), /*#__PURE__*/_react["default"].createElement("div", {
