...
var _MutilDatePicker = _interopRequireDefault(require("./MutilDatePicker"));
  ...
  _createClass(DatePicker, [{
      ...
      if (typeof value === 'string' && !!value) {
        ...
        try {
          switch (type) {
            ...
            case 'HH:mm:ss':
              date = (0, _moment["default"])(value, type);
    ...
    value: function _getContent() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_HrContext.Consumer, null, function (_ref) {
        ...
        switch (type) {
          case 'yyyy/MM/dd HH:mm':
            content = /*#__PURE__*/_react["default"].createElement(_MutilDatePicker["default"], {
              title: _pickerTitle,
          ...
          case 'yyyy/MM/dd':
            content = /*#__PURE__*/_react["default"].createElement(_index["default"], {
              title: _pickerTitle,
    ...
    value: function renderSuffixIcon() {
      ...
      return !disabled && !readOnly ? /*#__PURE__*/_react["default"].createElement(_index3["default"], {
        type: "time",
        size: "small",
        className: arrowCls
      }) : null;
    ...
    value: function render() {
      ...
      var wrapCls = (0, _classnames3["default"])(prefixCls, className, _defineProperty({}, "".concat(prefixCls, "-read-only"), readOnly));
      ...
      }, !(0, _data_util.isEmpty)(value) ? showLabel : /*#__PURE__*/_react["default"].createElement("span", {
        className: "".concat(prefixCls, "-place-holder")
      }, placeholder)), this.renderSuffixIcon()), /*#__PURE__*/_react["default"].createElement(_index2["default"], {
        direction: "bottom",
