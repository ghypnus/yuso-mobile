...
var Input = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var wrapCls = (0, _classnames3["default"])(prefixCls, className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-icon"), icon !== undefined), _defineProperty(_classnames, "".concat(prefixCls, "-search"), icon === 'search'), _defineProperty(_classnames, "".concat(prefixCls, "-small"), size === 'small'), _defineProperty(_classnames, "".concat(prefixCls, "-align-left"), align === 'left'), _defineProperty(_classnames, "".concat(prefixCls, "-align-center"), align === 'center'), _defineProperty(_classnames, "".concat(prefixCls, "-align-right"), align === 'right'), _defineProperty(_classnames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classnames, "".concat(prefixCls, "-read-only"), readOnly), _classnames));
      var iconCls = (0, _classnames3["default"])("".concat(prefixCls, "-icon-").concat(icon), _defineProperty({}, "".concat(prefixCls, "-icon-").concat(icon, "-active"), active));
      var inputType = 'text';
      ...
      }, /*#__PURE__*/_react["default"].createElement("span", null, ismust ? '*' : ''), title), /*#__PURE__*/_react["default"].createElement("input", _extends({}, patternProps, {
        name: name,
      ...
      }, suffix), needClose && /*#__PURE__*/_react["default"].createElement(_index["default"], {
      ...
      }), eye && /*#__PURE__*/_react["default"].createElement("div", {
        className: "eye",
        onClick: function onClick(e) {
