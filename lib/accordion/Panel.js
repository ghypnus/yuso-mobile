...
var Panel = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Panel, [{
    ...
    value: function render() {
      ...
      var titleCls = (0, _classnames["default"])("".concat(prefixCls, "-title"));
      var itemCls = (0, _classnames["default"])((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-item"), true), _defineProperty(_classNames, "".concat(prefixCls, "-item-active"), isActive), _defineProperty(_classNames, "".concat(prefixCls, "-item-disabled"), disabled), _classNames), className);

      var icon = /*#__PURE__*/_react["default"].createElement(_index["default"], {
        className: "arrow",
        type: "unfold"
      });
      ...
      }, showArrow && icon, title, extra && /*#__PURE__*/_react["default"].createElement("div", {
        className: "".concat(prefixCls, "-extra")
      }, extra)), /*#__PURE__*/_react["default"].createElement(_PanelContent["default"], {
        ref: function ref(el) {
