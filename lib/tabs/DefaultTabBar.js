...
var _animate = require("../_utils/animate");
...
var DefaultTabBar = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function DefaultTabBar(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onPan", function () {
      ...
      return {
        ...
        onPanMove: function onPanMove(status) {
          ...
          (0, _animate.setPxStyle)(_this.layout, offset, 'px', isVertical);
          finalOffset = offset;
        ...
        onPanEnd: function onPanEnd() {
          ...
          _this.setState({
            isMoving: false,
            transform: (0, _animate.getPxStyle)(finalOffset, 'px', isVertical)
          });
        },
    ...
    _defineProperty(_assertThisInitialized(_this), "getTransformByIndex", function (props) {
      ...
      return {
        transform: (0, _animate.getPxStyle)(skipSize, '%', isVertical),
  ...
  _createClass(DefaultTabBar, [{
    ...
    value: function renderTabBar() {
      ...
      var cls = (0, _classnames2["default"])(prefixCls, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-animated"), animated && !isMoving), _defineProperty(_classnames, "".concat(prefixCls, "-affix"), affix), _classnames));
      ...
      var transformStyle = needScroll ? _objectSpread({}, (0, _animate.getTransformPropValue)(transform)) : {};
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        style: style
      }, showPrev && /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, Tabs, renderUnderline ? renderUnderline(underlineProps) : /*#__PURE__*/_react["default"].createElement("div", underlineProps)), showNext && /*#__PURE__*/_react["default"].createElement("div", {
    ...
    value: function render() {
      ...
      return affix ? /*#__PURE__*/(0, _reactDom.createPortal)(this.renderTabBar(), this.rootEl) : this.renderTabBar();
    }
  }]);
