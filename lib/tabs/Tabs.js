...
var YusoTabs = /*#__PURE__*/function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onPan", function () {
      ...
      return {
        ...
        onPanMove: function onPanMove(status) {
          ...
          (0, _animate.setPxStyle)(_this.layout, offset, 'px', isVertical, useLeftInsteadTransform);
          finalOffset = offset;
        },
        onPanEnd: function onPanEnd() {
          ...
          if (offsetIndex === _this.state.currentTab) {
            if (_this.props.usePaged) {
              (0, _animate.setTransform)(_this.layout.style, _this.getContentPosByIndex(offsetIndex, _this.isTabVertical(), _this.props.useLeftInsteadTransform));
            }
          } else {
  ...
  _createClass(YusoTabs, [{
    ...
    value: function renderTabBar(tabBarProps, DefaultTabBar) {
      ...
      return /*#__PURE__*/_react["default"].createElement(DefaultTabBar, tabBarProps);
    }
  }, {
    key: "renderContent",
    value: function renderContent() {
      ...
      var contentStyle = animated ? useLeftInsteadTransform ? _objectSpread({
        ...
        left: contentPos
      }) : (0, _animate.getTransformPropValue)(contentPos) : _objectSpread({
        position: 'relative'
      }, this.isTabVertical() ? {
    ...
    value: function render() {
      ...
      }, this.renderTabBar(tabBarProps, _DefaultTabBar["default"])), !noRenderContent && this.renderContent()];
      return /*#__PURE__*/_react["default"].createElement("div", {
...
exports["default"] = YusoTabs;

_defineProperty(YusoTabs, "DefaultTabBar", _DefaultTabBar["default"]);
