...
var Message = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      var iconWrap = classnames("".concat(prefixCls, "-icon"), (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-icon-success"), icon === 'success'), _defineProperty(_classnames, "".concat(prefixCls, "-icon-fail"), icon === 'fail'), _classnames));
      var titleIconWrap = icon === 'success' ? "".concat(prefixCls, "-title-success") : '';
      var actionWrap = classnames("".concat(prefixCls, "-action"), (_classnames2 = {}, _defineProperty(_classnames2, "".concat(prefixCls, "-action-row"), direction === 'row'), _defineProperty(_classnames2, "".concat(prefixCls, "-action-column"), direction === 'column'), _classnames2));
