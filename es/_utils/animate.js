...
export var getTransformPropValue = function getTransformPropValue(v) {
  return {
    transform: v,
    WebkitTransform: v,
    MozTransform: v
...
export var getPxStyle = function getPxStyle(value) {
...
export var setPxStyle = function setPxStyle(el, value) {
