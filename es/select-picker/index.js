...
var SelectPicker = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SelectPicker, [{
    ...
    value: function renderSuffixIcon() {
      ...
      var allowClear = !disabled && !readOnly && close && !isEmpty(value || defaultValue);
    ...
    value: function render() {
      ...
      var wrapperCls = classnames(prefixCls, className, (_classnames2 = {}, _defineProperty(_classnames2, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classnames2, "".concat(prefixCls, "-read-only"), readOnly), _classnames2));
      return /*#__PURE__*/React.createElement(Consumer, null, function (_ref) {
        ...
        }, !isEmpty(selectedValues) ? labels : /*#__PURE__*/React.createElement("span", {
