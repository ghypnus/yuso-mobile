...
var ListItem = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      var thumbCls = classnames("".concat(prefixCls, "-thumb"), (_classnames2 = {}, _defineProperty(_classnames2, "".concat(prefixCls, "-thumb-large"), size === 'large'), _defineProperty(_classnames2, "".concat(prefixCls, "-thumb-small"), size === 'small'), _defineProperty(_classnames2, "".concat(prefixCls, "-thumb-normal"), size === 'normal'), _defineProperty(_classnames2, "".concat(prefixCls, "-thumb-square"), size === 'square'), _classnames2)); // iocn

      var iconCls = classnames("".concat(prefixCls, "-icon"), (_classnames3 = {}, _defineProperty(_classnames3, "".concat(prefixCls, "-icon-active"), selected), _defineProperty(_classnames3, "".concat(prefixCls, "-icon-unactive"), !selected), _classnames3)); // 多行文本、文本换行方式

      var lineCls = classnames("".concat(prefixCls, "-line"), (_classnames4 = {}, _defineProperty(_classnames4, "".concat(prefixCls, "-line-multiple"), multipleLine), _defineProperty(_classnames4, "".concat(prefixCls, "-line-ellipsis"), ellipsis), _defineProperty(_classnames4, "".concat(prefixCls, "-line-wrap"), wrap), _defineProperty(_classnames4, "".concat(prefixCls, "-line-selected"), selected), _classnames4)); // 箭头和它方向
      ...
      var underlineCls = classnames("".concat(prefixCls, "-underline"));
      ...
      }) : null, icon ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Icon, {
        type: icon,
        size: iconSize,
        className: iconCls
      })) : null, children !== undefined && /*#__PURE__*/React.createElement("div", {
        className: lineCls
      }, /*#__PURE__*/React.createElement("div", {
        className: "".concat(prefixCls, "-content")
      }, children), extra !== undefined && /*#__PURE__*/React.createElement("div", {
        className: "".concat(prefixCls, "-extra")
      }, extra), arrow && /*#__PURE__*/React.createElement(Icon, {
        type: "enter",
        size: "small",
        className: arrowCls
      }), underline && selected && /*#__PURE__*/React.createElement("div", {
