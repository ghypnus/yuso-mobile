...
var Calendar = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function valueChange(value) {
      ...
      var currentDate = value ? moment(value) : moment();
      this.setState({
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.props.value && (!prevProps.value || moment(prevProps.value).valueOf() != moment(this.props.value).valueOf())) {
    ...
    value: function getWeek(_ref) {
      ...
      return this.props.week[moment(date).format('E') - 1];
    }
    /**
     * 生成多维数组
     */
    ...
    value: function getFormateDate(day, type) {
      ...
      if (type === 'prev') {
        ...
        prefix = moment(currentDate).date(moment(currentDate).endOf('month').date() + 1).format('YYYY-MM');
      } else {
    ...
    value: function getCellClass(cell, isDisabled, prefixCls) {
      ...
      return classnames(prefixCls, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-in-view"), cell.type === 'current'), _defineProperty(_classnames, "".concat(prefixCls, "-disabled"), isDisabled), _defineProperty(_classnames, "".concat(prefixCls, "-selected"), this.isSelected(cell)), _defineProperty(_classnames, "".concat(prefixCls, "-current"), this.isCurrentDay(cell)), _classnames));
    }
    /**
     * 是否已选中
     */
    ...
    value: function renderCell(_ref5) {
      ...
      return cell || /*#__PURE__*/React.createElement("div", {
    ...
    value: function renderGrid() {
      ...
      }, /*#__PURE__*/React.createElement("thead", null, this.renderWeek()), /*#__PURE__*/React.createElement("tbody", null, gridData.map(function (rows, rowIndex) {
        return /*#__PURE__*/React.createElement("tr", {
          ...
          if (mode === 'edit' && disabledDate) {
            isDisabled = !!disabledDate(moment(_this3.getFormateDate(col.text, col.type)));
          }
    ...
    value: function renderTitle() {
      ...
      }, moment(currentDate).format('YYYY-MM')), /*#__PURE__*/React.createElement("div", {
        className: "next-btn",
        onClick: function onClick() {
          _this4.switchMonth(1);
        }
    ...
    value: function renderList() {
      ...
      return /*#__PURE__*/React.createElement(List, {
        ...
        if (mode === 'edit' && disabledDate) {
          isDisabled = !!disabledDate(moment(_this5.getFormateDate(cell.text, cell.type)));
        }
        ...
        return /*#__PURE__*/React.createElement(List.Item, {
          ...
          className: "day-text"
        }, cell.text), /*#__PURE__*/React.createElement("div", {
          className: "day-week"
        }, _this5.getWeek(cell))), dateCellRender && dateCellRender(moment(_this5.getFormateDate(cell.text, cell.type)))));
      }));
    }
  }, {
    key: "render",
